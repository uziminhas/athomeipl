      ...
      <Container>
        ...
        >
          <div className={'flex w-full flex-1 flex-col items-center space-y-8'}>
            <Pill>
              <span>The leading blog for IPL hair removal devices</span>
            </Pill>

            <HeroTitle>
              <span>Discover the Art of Effortless Beauty with</span>
              <span
                className={
            ...
            <SubHeading className={'text-center'}>
              <span>Submerge into the world of convenient, safe, and effective hair</span>
              <span>removal right from the comfort of your home.</span>
              <span>Explore our expert reviews, tips, and guides to</span>
              <span>find the perfect IPL solution for your skin.</span>
            </SubHeading>
        ...
        >
          <Image
            ...
            width={2688}
            height={1824}
            src={`/assets/images/ipl_device_sleek.webp`}
            alt={`App Image`}
          />
        </div>
      </Container>
